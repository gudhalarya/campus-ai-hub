    ...
    <div className="min-h-screen overflow-hidden">
      <section className="relative">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-80 sm:w-96 h-80 sm:h-96 rounded-full bg-primary/5 blur-3xl animate-float" />
          <div className="absolute -bottom-20 -left-20 w-64 sm:w-72 h-64 sm:h-72 rounded-full bg-primary/3 blur-3xl animate-float" style={{ animationDelay: "1.5s" }} />
        </div>

        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-14 sm:pt-24 pb-16 sm:pb-28 text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-border bg-card/80 backdrop-blur-sm px-3 sm:px-4 py-1.5 text-[11px] sm:text-xs font-medium text-muted-foreground mb-6 sm:mb-8 opacity-0 animate-fade-in">
            <span className="w-2 h-2 rounded-full bg-primary animate-pulse-glow" />
            Offline-First • LAN-Based • Open Source
          </div>

          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-4 sm:mb-6 opacity-0 animate-blur-in" style={{ animationDelay: "0.15s" }}>
            Campus AI Node
            <br />
            <span className="gradient-text">Free AI for Every Student</span>
          </h1>

          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto mb-8 sm:mb-10 opacity-0 animate-slide-up" style={{ animationDelay: "0.3s" }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 opacity-0 animate-slide-up" style={{ animationDelay: "0.45s" }}>
            <Link
              to="/workspace"
              className="group inline-flex w-full sm:w-auto justify-center items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-lg font-medium text-sm hover:opacity-90 transition-all duration-300 hover:shadow-lg hover:shadow-primary/25 hover-scale"
            >
            ...
            <Link
              to="/utility-builder"
              className="inline-flex w-full sm:w-auto justify-center items-center gap-2 border border-border bg-card text-foreground px-6 py-3 rounded-lg font-medium text-sm hover:bg-secondary transition-all duration-300 hover-scale"
            >
              Explore Tools
            </Link>
          </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pb-16 sm:pb-28">
        <div className="text-center mb-10 sm:mb-14 opacity-0 animate-fade-in" style={{ animationDelay: "0.5s" }}>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {features.map((f, i) => (
            <div
              key={f.title}
              className="group rounded-xl border border-border bg-card p-5 sm:p-6 hover:border-primary/30 transition-all duration-500 hover-lift opacity-0 animate-stagger-in"
      ...
      <section className="border-t border-border bg-card/50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center">
          ...
          <p className="text-muted-foreground mb-10 sm:mb-14 max-w-xl mx-auto opacity-0 animate-fade-in" style={{ animationDelay: "0.2s" }}>Three steps from browser to AI.</p>
      ...
      <footer className="border-t border-border">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8 flex flex-col sm:flex-row gap-3 sm:gap-0 items-center justify-between opacity-0 animate-fade-in" style={{ animationDelay: "0.2s" }}>
